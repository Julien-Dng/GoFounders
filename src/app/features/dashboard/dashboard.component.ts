        ...
        <div class="p-4 border-t border-primary-foreground/10">
          <div class="flex items-center gap-3 p-3 rounded-lg bg-primary-foreground/5 hover:bg-primary-foreground/10 transition-colors cursor-pointer">
            ...
            <div class="flex-1 min-w-0">
              <div class="font-semibold text-sm truncate">Marc Julien</div>
              <div class="flex items-center gap-1.5">
                <span class="text-xs px-2 py-0.5 bg-muted/20 text-muted rounded">FREE</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <header class="bg-white border-b border-border sticky top-0 z-40">
          <div class="px-8 h-16 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
              ...
              <div class="w-9 h-9 bg-gradient-to-br from-accent to-primary rounded-full flex items-center justify-center text-white font-bold cursor-pointer">MJ</div>
            </div>
          </div>
        </header>
...
export class DashboardComponent {
  ...
  readonly sidebarItems = [
    { id: 'accueil', label: 'Accueil', emoji: '🏠', path: '/dashboard' },
    { id: 'recherche', label: 'Recherche', emoji: '🔍', path: '/recherche' },
    { id: 'matches', label: 'Mes Matches', emoji: '👥', path: '/dashboard' },
    { id: 'messages', label: 'Messages', emoji: '💬', badge: 3, path: '/dashboard' },
    { id: 'ma', label: 'M&A', emoji: '📈', path: '/ma' },
    { id: 'assistant', label: 'Assistant IA', emoji: '✨', path: '/assistant' },
    { id: 'abonnement', label: 'Abonnement', emoji: '💳', path: '/tarifs' },
    { id: 'parametres', label: 'Paramètres', emoji: '⚙️', path: '/dashboard' },
  ];
